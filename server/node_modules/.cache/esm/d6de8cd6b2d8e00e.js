let Router,randomBytes,Profile,User,multer;_b2d‍.x([["default",()=>_b2d‍.o]]);_b2d‍.w("express",[["Router",["Router"],function(v){Router=v}]]);_b2d‍.w("crypto",[["randomBytes",["randomBytes"],function(v){randomBytes=v}]]);_b2d‍.w("../models",[["Profile",["Profile"],function(v){Profile=v}],["User",["User"],function(v){User=v}]]);_b2d‍.w("multer",[["default",["multer"],function(v){multer=v}]]);
...
router.post("/register", async (req, res) => {
    ...
    try {
        ...
        _b2d‍.g.console.log('User', user)
        

    } catch (err) {
        _b2d‍.g.console.log('ERR :', err.message)
